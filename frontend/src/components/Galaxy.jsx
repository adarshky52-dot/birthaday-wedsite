...
export default function Galaxy({
  ...
  // Update WebGL uniforms dynamically when props change
  useEffect(() => {
  ...
  }, [hueShift, density, speed, starSpeed, glowIntensity, saturation, rotationSpeed]);
  ...
  useEffect(() => {
    ...
    try {
      ...
      gl = renderer.gl;
      if (!gl) {
        throw new Error("Renderer.gl context is null");
      }
      isInitialized = true;
    } catch (e) {
      console.warn("WebGL not supported or context creation failed. Disabling Galaxy effect:", e);
      return;
    }
